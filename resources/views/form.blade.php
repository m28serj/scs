				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group clearfix">
							...
							<div class="col-md-9">
								{!! Form::select('locale', $locales->lists('name', 'code'), null, ['class' => 'form-control']) !!}
							</div>
						</div>
						<div class="form-group clearfix">
						...
						<div class="form-group clearfix">
							{!! Form::label('periodicity', 'Периодичность:', ['class' => 'col-md-3 control-label']) !!}
							<div class="col-md-9">
								{!! Form::select('periodicity', $periods->lists('name', 'interval'), null, ['class' => 'form-control']) !!}
							</div>
						</div>
					</div>
					<div class="col-md-6">
